...
// TODO: this can certainly be improved, and made to use no containers with dynamic allocation
...
struct GroupedBlockStructure {
	...
	GroupedBlockStructure(const BlockStructure& blockStructure, const std::vector<uint64_t>& aggregParamStart);
};
