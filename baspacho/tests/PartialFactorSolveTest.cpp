...
TEST(Partial, PartialFragmentedSolveLt_Ref_double) {
  testPartialFragmentedSolveLt_Many<double>([] { return simpleOps(); });
}

TEST(Partial, PartialFragmentedSolveLt_Ref_float) {
